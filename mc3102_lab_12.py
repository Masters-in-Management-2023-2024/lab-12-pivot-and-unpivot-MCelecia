...
Original file is located at
    https://colab.research.google.com/drive/11wxVgG5uOgXeH78XbOrMhsZkHTG5vM0e
...
print(economics_wide.head(5).tail(5))
...
std_passengers = (
    air_passengers_long
    .filter((pl.col("Year") >= 1955) & (pl.col("Year") <= 1960)) # Corrected 'year' to 'Year'
    .select(pl.col("passenger").std()) # Corrected 'passengers' to 'passenger'
...
year_1999 = table2_with_ratio.filter(pl.col("year") == 1999).sort("ratio", descending=True).select(["country","ratio"])
